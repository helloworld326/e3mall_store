...
<script src="${pageContext.request.contextPath}/js/jquery.qrcode.js?v=20160713" type="text/javascript" ></script>
<script src="${pageContext.request.contextPath}/js/product.js?v=20160713" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/js/qrcode.js?v=20160713" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/js/cookie.js?v=20160416222" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/js/shadow.js?v=20160416" type="text/javascript"></script>
...
<body>
	...
	<div class="linknav">
		<div class="breadcrumb">
			<strong><a href="/food/6-0-0-0-0-2-0-0-0-0-0.html">休闲食品</a></strong><span>
				&gt; <a href="/food/7321-0-0-0-0-2-0-0-0-0-0.html">月饼</a> &gt; <a
				href="/food/7331-0-0-0-0-2-0-0-0-0-0.html">其他月饼</a> &gt; <a
				href="http://www.e3mall.cn/pinpai/7331-10863.html">我是花吃</a> &gt;
				我是花吃 我是花吃鲜花月饼团圆礼盒390g
			</span>
		</div>
	</div>
	<div class="pWrap">
		<div class="productIntro">
			<div class="pItems">
				<div class="pItemsMain">
					<div class="pItemsName">
						<div class="cm">
							<h1 id="base_name-sf">${item.title }</h1>
							<br></br> <strong id="adword-sf" title="" class="">${item.sellPoint }</strong>
						</div>
					</div>
					<div class="pItemsPrice" id="price-sf">
						<div class="priceBox">
							<span class="dt">优选价：</span><span class="rmb">￥</span> <strong
								class="price"><fmt:formatNumber groupingUsed="false"
					...
					<div class="pItemsStock">
						...
						<div class="dd">
							...
							<div class="pItemsPrompt" id="time-sf">
								原产地直供，发货后预计<strong>2-5天</strong>内为您送达
							</div>
						</div>
					...
					<div class="pItemsChoose">
						...
						<div class="chooseBtns" id="buy-btn-sf">
							<div class="pAmount">
								<span><input type="text" id="number_${item.id}"
									class="text" value=""></span> <span> <a
									href="javascript:;" id="add-sell-num" class="p-add">+</a> <a
							...
							<div class="pBtn quickBuy" style="display: none;" id="quickBuy"
								title="快速下单，直达填写订单页面">
								<a onclick="oneKeyBuy(${item.id}, 0, 1, 0, 1, this);">一键购买</a>
							</div>
							<div class="yj_time" id="sendTime">
								预计发货时间：<br>2014-02-28 08:59
							</div>
							<div class="phone_client phone_border">
								<div id="phone_time">
									扫描下载客户端<br><em>先摇券 后买单</em>
								</div>
								<!--手机二维码显示层-->
						...
						<div class="chooseBtns" id="buy-nogood-sf" style="display:none">
							<div class="pBtn">
								<span class="noShip">已售完</span>
							</div>
							<div class="pBtn preBtn" id="arrival_notice">
								<a href="javascript:void(0);"
									onclick="Goods.arrivalNotice(this);">到货通知</a>
							</div>
							<div class="pBtn quickBuy disable">
								<a href="javascript:void(0);">一键购买</a>
							</div>
							<div class="phone_client phone_border">
								<div id="phone_time">
									扫描下载客户端<br><em>先摇券 后买单</em>
								...
								<div class="phone_clientCode" style="display:none;">
									...
									<div class="qrcodeTable" id="qrcodeTableBig1">
										<table
											style="width: 124px; height: 124px; border: 0px; border-collapse: collapse; background-color: rgb(255, 255, 255);">
											<tbody>
												<tr style="height: 3.02439px;">
													<td
														style="width: 3.02439px; background-color: rgb(0, 0, 0);"></td>
													<td
														style="width: 3.02439px; background-color: rgb(0, 0, 0);"></td>
													<td
														style="width: 3.02439px; background-color: rgb(0, 0, 0);"></td>
													...
													<td
														style="width: 3.02439px; background-color: rgb(0, 0, 0);"></td>
													<td
														style="width: 3.02439px; background-color: rgb(255, 255, 255);"></td>
													<td
														style="width: 3.02439px; background-color: rgb(255, 255, 255);"></td>
													<td
														style="width: 3.02439px; background-color: rgb(255, 255, 255);"></td>
				...
				<div class="pView">
					<div id="pView">
						...
						<div id="pic-list">
							<a href="javascript:void(0);" class="btn-control disabled"
								id="btn-forward"><b></b></a> <a href="javascript:void(0);"
								class="btn-control disabled" id="btn-backward"><b></b></a>

							<div class="pic-items"
								style="position: absolute; width: 50px; height: 300px; overflow: hidden;">
								<ul
									style="position: absolute; left: 0px; top: 0px; height: 240px;">
									<c:forEach items="${item.images }" var="image">
										<li style="float: left;"><img title="${item.title } "
											alt="${item.title }" src="${image }"></li>
									</c:forEach>
								</ul>
							</div>
						</div>
					...
					<div class="pShare">
						<div class="bdShare">
							...
							<div id="bdshare" class="bdshare_t bds_tools get-codes-bdshare">
								<span class="bds_more">分享到：</span> <a class="bds_qzone"
									...
									title="分享到新浪微博" href="#"></a> <a class="bds_tqq"
									title="分享到腾讯微博" href="#"></a> <a class="bds_renren"
									title="分享到人人网" href="#"></a>
								<!--a class="bds_t163"></a-->
						...
						<!-- Baidu Button END -->
						<div class="pCollect">
							<a href="javascript:void(0);" id="goodsAddFav"
								onclick="Goods.addFav(this);">收藏商品</a>
						</div>
						<span class="clear"></span>
					</div>
				</div>
			...
			<div class="pItemsSide">
				...
				<div class="pdetail">
					<ul>
						<li>品牌：<span><a
								href="http://www.e3mall.cn/pinpai/7331-10863.html" title="我是花吃"
								target="_blank">我是花吃</a></span></li>
						<li>产地：<span><a
								href="/food/7331-0-45-0-0-2-0-0-0-0-0.html" title="中国"
								target="_blank">中国</a></span>
						</li>
						<li>重量：1.4kg （含包装）</li>
						<li>商品编号：${item.id }</li>
						<li class="card-pay"><span class="card-pay-left">优选卡</span> <span
							class="card-pay-right">支持优选卡支付</span></li>
					</ul>
					<div class="pDeclare">
				...
				<div class="pcommdetail">
					<dl class="prate">
						...
						<dd>
							<div class="dd">
								<span id="positive-sf" style="100%"></span>
							</div>
	...
	<div class="pWrap">
		<div class="main-box">
			...
			<div class="pDetail">
				...
				<div id="add-cart-r-btn-sf" class="p-btn">
					<a href="javascript:void(0);"
			...
			<div class="pCont cpjs_box" id="div-detail">
				...
				<div
					...
					<span
						style="float: left; width: 100px; text-align: right; padding-right: 6px; margin-right: 6px;">温馨提示：</span>
